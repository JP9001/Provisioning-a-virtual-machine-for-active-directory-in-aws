...
## Creating a Virtual Machine for Active Directory on AWS

### Objective

This SOP outlines the steps to create a virtual machine for Active Directory using AWS, ensuring a smooth and efficient process for team members.
...
- Select 't3.2xlarge' (32 GB memory) to ensure optimal performance.
